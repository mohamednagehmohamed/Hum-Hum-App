...
//void main() => runApp(ScraEgg());

class ScraEgg extends StatefulWidget {
  @override
  ScraEggState createState() => ScraEggState();
}

class ScraEggState extends State<ScraEgg> {
                          ...
                          child: ListTile(
                            title: Text(
                              HomePageState.arabicvalue == false
                                  ...
                                  : '1 ملعقة صغيرة حليب أو حليب نبات أو ماء',
                              style: TextStyle(
                                  fontSize: 18,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white),
                          ...
                          child: ListTile(
                            title: Text(
                              HomePageState.arabicvalue == false
                                  ...
                                  : 'زيت زيتون أو زبدة بكر اكسترا للمقلاة',
                              style: TextStyle(
                                  fontSize: 18,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white),
                          ...
                          child: ListTile(
                            title: Text(
                              HomePageState.arabicvalue == false
                                  ...
                                  : 'ملح البحر والفلفل الأسود الطازج',
                              style: TextStyle(
                                  fontSize: 18,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white),
                          ...
                          child: ListTile(
                            title: Text(
                              HomePageState.arabicvalue == false
                                  ...
                                  : 'اكسر البيض في وعاء متوسط ​​الحجم وأضف الحليب أو الماء. اخفقي حتى تصبح ناعمة ومختلطة ، مع عدم وجود خطوط من بياض البيض المتبقي',
                              style: TextStyle(
                                  fontSize: 20,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white),
                          ...
                          child: ListTile(
                            title: Text(
                              HomePageState.arabicvalue == false
                                  ...
                                  : 'ادهن مقلاة صغيرة غير لاصقة بزيت الزيتون أو قم بإذابة القليل من الزبدة في مقلاة صغيرة غير لاصقة. اجلبها إلى درجة حرارة متوسطة',
                              style: TextStyle(
                                  fontSize: 20,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white),
                          ...
                          child: ListTile(
                            title: Text(
                              HomePageState.arabicvalue == false
                                  ...
                                  : 'صب البيض واتركه يطهى لبضع ثوان دون تحريك. اسحب ملعقة مطاطية عبر قاع المقلاة لتشكيل خثارة كبيرة وناعمة من البيض المخفوق',
                              style: TextStyle(
                                  fontSize: 20,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white),
                          ...
                          child: ListTile(
                            title: Text(
                              HomePageState.arabicvalue == false
                                  ...
                                  : 'استمر في الطهي على نار متوسطة منخفضة ، وقم بطي وتقليب البيض كل بضع ثوان. اكشط الملعقة على طول قاع وجوانب المقلاة في كثير من الأحيان لتشكيل المزيد من الخثارة ولمنع أي جزء من البيض من الجفاف',
                              style: TextStyle(
                                  fontSize: 20,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white),
                          ...
                          child: ListTile(
                            title: Text(
                              HomePageState.arabicvalue == false
                                  ...
                                  : 'ارفعي المقلاة عن النار عندما ينضج البيض في الغالب ، لكن يتبقى القليل من البيض السائل. يتبل بالملح والفلفل حسب الرغبة ويُزين بالثوم المعمر الطازج المفروم ، إذا رغبت في ذلك',
                              style: TextStyle(
                                  fontSize: 20,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white),
