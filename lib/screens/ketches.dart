...
//void main() => runApp(Ketches());

class Ketches extends StatefulWidget {
  @override
  KetchesState createState() => KetchesState();
}

class KetchesState extends State<Ketches> {
    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          toolbarHeight: 70,
          title: Text(
            HomePageState.arabicvalue == false ? 'Käsespätzle' : 'نودلز الجبن',
            style: TextStyle(
                          ...
                          child: ListTile(
                            title: Text(
                              HomePageState.arabicvalue == false
                                  ...
                                  : 'دفعة واحدة من Spätzle الألمانية محلية الصنع (حوالي 5 أكواب مطبوخة من Spätzle ، يمكن استخدامها في المتجر إذا كان ذلك مفضلاً) ، ويمكن تحضيرها مسبقًا وتبريدها حتى الاستخدام الجاهز ، ثم اتركها دافئة لدرجة حرارة الغرفة قبل الخبز',
                              style: TextStyle(
                                  fontSize: 18,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white),
                          ...
                          child: ListTile(
                            title: Text(
                              HomePageState.arabicvalue == false
                                  ...
                                  : '12 أونصة ممزقة من Emmentaler أو Jarlsberg (تشبه السويسري من النرويج ، خفيفة) (يمكنك أيضًا إضافة بعض Gruyere للحصول على نكهة إضافية)',
                              style: TextStyle(
                                  fontSize: 18,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white),
                          ...
                          child: ListTile(
                            title: Text(
                              HomePageState.arabicvalue == false
                                  ...
                                  : 'سخني الفرن إلى 400 درجة فهرنهايت. زبدة طبق خزفي بحجم 9 × 13 (أو أصغر قليلاً)',
                              style: TextStyle(
                                  fontSize: 20,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white),
                          ...
                          child: ListTile(
                            title: Text(
                              HomePageState.arabicvalue == false
                                  ...
                                  : 'لتحضير البصل المكرمل: نذوب الزبدة في قدر متوسط ​​الحجم أو فرن هولندي. يضاف البصل ويقلب من وقت لآخر لمدة 20-30 دقيقة حتى يتكرمل بعمق في منتصف الطريق مع رش القليل من الملح والسكر للمساعدة في تحويل الكراميل. احصل على البصل لطيفا وبني اللون',
                              style: TextStyle(
                                  fontSize: 20,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white),
                          ...
                          child: ListTile(
                            title: Text(
                              HomePageState.arabicvalue == false
                                  ...
                                  : 'طبقة 1/3 من Spätzle في قاع الطبق متبوعة بثلث الجبن و 1/3 من البصل بالكراميل. كرر ذلك ، مع رش كل طبقة بالقليل من الملح ، وتنتهي بالجبن والبصل في الأعلى',
                              style: TextStyle(
                                  fontSize: 20,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white),
                          ...
                          child: ListTile(
                            title: Text(
                              HomePageState.arabicvalue == false
                                  ...
                                  : 'اخبزي لمدة 10 دقائق أو أكثر حتى تذوب الجبن وتبدأ الأطراف في الحصول على القليل من الهشاشة وقدميها على الفور.',
                              style: TextStyle(
                                  fontSize: 20,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white),
