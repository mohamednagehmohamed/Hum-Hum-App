...
//void main() => runApp(Bucha());

class Bucha extends StatefulWidget {
  @override
  BuchaState createState() => BuchaState();
}

class BuchaState extends State<Bucha> {
    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          toolbarHeight: 70,
          title: Text(
            HomePageState.arabicvalue == false ? 'Bun cha' : 'بون تشا',
            style: TextStyle(
                          ...
                          child: ListTile(
                            title: Text(
                              HomePageState.arabicvalue == false
                                  ...
                                  : '250-300 جم / 8-10 أوقية لحم خنزير مفروم (لحم خنزير مفروم) (الملاحظة 1)',
                              style: TextStyle(
                                  fontSize: 18,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white),
                          ...
                          child: ListTile(
                            title: Text(
                              HomePageState.arabicvalue == false
                                  ...
                                  : '1 ملعقة كبيرة صلصة سمك (ملحوظة 2)',
                              style: TextStyle(
                                  fontSize: 18,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white),
                          ...
                          child: ListTile(
                            title: Text(
                              HomePageState.arabicvalue == false
                                  ...
                                  : '1/3 كوب بصل أخضر مفروم ناعماً / بصل أخضر',
                              style: TextStyle(
                                  fontSize: 18,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white),
                          ...
                          child: ListTile(
                            title: Text(
                              HomePageState.arabicvalue == false
                                  ...
                                  : '2 ملعقة صغيرة معجون ليمون طازج أو مفروم ناعماً (اختياري)',
                              style: TextStyle(
                                  fontSize: 18,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white),
                          ...
                          child: ListTile(
                            title: Text(
                              HomePageState.arabicvalue == false
                                  ...
                                  : '1 عين طائر فلفل حار ، منزوع البذور ومفروم ناعماً',
                              style: TextStyle(
                                  fontSize: 18,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white),
                          ...
                          child: ListTile(
                            title: Text(
                              HomePageState.arabicvalue == false
                                  ...
                                  : 'قليل من أوراق الخس المطوية أو المقطعة',
                              style: TextStyle(
                                  fontSize: 18,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white),
                          ...
                          child: ListTile(
                            title: Text(
                              HomePageState.arabicvalue == false
                                  ...
                                  : 'جزر جوليين وفجل أبيض (دايكون) ، مخلل سريع اختياري',
                              style: TextStyle(
                                  fontSize: 18,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white),
                          ...
                          child: ListTile(
                            title: Text(
                              HomePageState.arabicvalue == false
                                  ...
                                  : 'الصلصة: تخلط المكونات. خصص 10 دقائق +',
                              style: TextStyle(
                                  fontSize: 20,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white),
                          ...
                          child: ListTile(
                            title: Text(
                              HomePageState.arabicvalue == false
                                  ...
                                  : 'النودلز: يُسكب فوق الماء المغلي وينقع في اتجاهات العبوة. يُصفّى ويُترك جانباً',
                              style: TextStyle(
                                  fontSize: 20,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white),
                          ...
                          child: ListTile(
                            title: Text(
                              HomePageState.arabicvalue == false
                                  ...
                                  : 'تخلط جميع المكونات ماعدا الزيت حتى تمتزج',
                              style: TextStyle(
                                  fontSize: 20,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white),
                          ...
                          child: ListTile(
                            title: Text(
                              HomePageState.arabicvalue == false
                                  ...
                                  : 'شكلي 6 قطع هامبرغر صغيرة بيديك',
                              style: TextStyle(
                                  fontSize: 20,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white),
                          ...
                          child: ListTile(
                            title: Text(
                              HomePageState.arabicvalue == false
                                  ...
                                  : 'سخني الزيت في مقلاة على نار متوسطة عالية. تُضاف الفطائر وتُطهى لمدّة دقيقتين ونصف أو حتى تصبح ذهبية اللون. اقلبه واتركه لمدة دقيقتين ثم أزله',
                              style: TextStyle(
                                  fontSize: 20,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white),
                          ...
                          child: ListTile(
                            title: Text(
                              HomePageState.arabicvalue == false
                                  ...
                                  : 'ضع المعكرونة في وعاء. ضعي حفنة من براعم الفاصولياء ، ودعيها في الخس والجزر والفجل',
                              style: TextStyle(
                                  fontSize: 20,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white),
                          ...
                          child: ListTile(
                            title: Text(
                              HomePageState.arabicvalue == false
                                  ...
                                  : 'ضعي كرات اللحم فوقها ، وضعي فوقها الكزبرة والنعناع',
                              style: TextStyle(
                                  fontSize: 20,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white),
                    ...
                    Padding(
                      ...
                      child: Container(
                          ...
                          child: ListTile(
                            title: Text(
                              HomePageState.arabicvalue == false
                                  ? 'Spoon over a generous amount of Sauce (its supposed to be like a soup broth), eat and be happy!'
                                  : 'ضعي كمية كبيرة من الصلصة بالملعقة (من المفترض أن تكون مثل مرق الحساء) ، وتناولي الطعام وكن سعيدًا!',
                              style: TextStyle(
                                  fontSize: 20,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white),
