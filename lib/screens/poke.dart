...
class PokeState extends State<Poke> {
                          ...
                          child: ListTile(
                            title: Text(
                              HomePageState.arabicvalue == false
                                  ...
                                  : '1/4 ج. صلصة الصويا منخفضة الصوديوم',
                              style: TextStyle(
                                  fontSize: 18,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white),
                          ...
                          child: ListTile(
                            title: Text(
                              HomePageState.arabicvalue == false
                                  ...
                                  : '1 ملعقة صغيرة. الزنجبيل المبشور الطازج',
                              style: TextStyle(
                                  fontSize: 18,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white),
                          ...
                          child: ListTile(
                            title: Text(
                              HomePageState.arabicvalue == false
                                  ...
                                  : '2 بصل أخضر مقطّع إلى شرائح رفيعة مع المزيد للتزيين',
                              style: TextStyle(
                                  fontSize: 18,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white),
                          ...
                          child: ListTile(
                            title: Text(
                              HomePageState.arabicvalue == false
                                  ...
                                  : '1 ملعقة صغيرة. بذور السمسم المحمص ، بالإضافة إلى المزيد للتزيين',
                              style: TextStyle(
                                  fontSize: 18,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white),
                          ...
                          child: ListTile(
                            title: Text(
                              HomePageState.arabicvalue == false
                                  ...
                                  : '1 رطل من تونة أهي من فئة السوشي ، مقطعة إلى قطع صغيرة الحجم',
                              style: TextStyle(
                                  fontSize: 18,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white),
                          ...
                          child: ListTile(
                            title: Text(
                              HomePageState.arabicvalue == false
                                  ...
                                  : 'في وعاء كبير ، اخفقي صلصة الصويا مع خل الأرز وزيت السمسم والزنجبيل ورقائق الفلفل الأحمر والبصل الأخضر وبذور السمسم. أضيفي التونة وقلبيها حتى تتغطى. برد لمدة 15 دقيقة على الأقل أو حتى ساعة واحدة',
                              style: TextStyle(
                                  fontSize: 20,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white),
                          ...
                          child: ListTile(
                            title: Text(
                              HomePageState.arabicvalue == false
                                  ...
                                  : 'للتقديم ، أضيفي الأرز إلى قاع أربعة أطباق. وزعي التونة والإضافات من اختيارك. يُزين بالبصل الأخضر وبذور السمسم قبل التقديم',
                              style: TextStyle(
                                  fontSize: 20,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white),
