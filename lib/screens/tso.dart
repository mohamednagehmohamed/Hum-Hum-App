...
//void main() => runApp(Tso());

class Tso extends StatefulWidget {
  @override
  TsoState createState() => TsoState();
}

class TsoState extends State<Tso> {
  @override
                        ...
                        child: ListTile(
                          title: Text(
                            HomePageState.arabicvalue == false
                                ...
                                : '2 رطل من أفخاذ الدجاج ، مقطعة إلى قطع بحجم 1 بوصة',
                            style: TextStyle(
                                fontSize: 18,
                                fontWeight: FontWeight.bold,
                                color: Colors.white),
                        ...
                        child: ListTile(
                          title: Text(
                            HomePageState.arabicvalue == false
                                ...
                                : '1 ملعقة صغيرة رقائق فلفل أحمر حار',
                            style: TextStyle(
                                fontSize: 18,
                                fontWeight: FontWeight.bold,
                                color: Colors.white),
                  ...
                  Padding(
                    ...
                    child: Container(
                        ...
                        child: ListTile(
                          title: Text(
                            HomePageState.arabicvalue == false
                                ? 'Cut chicken into 1-inch cubes. Toss each piece with cornstarch'
                                : 'قطع الدجاج إلى مكعبات 1 بوصة. قلبي كل قطعة مع نشا الذرة',
                            style: TextStyle(
                                fontSize: 20,
                                fontWeight: FontWeight.bold,
                                color: Colors.white),
                        ...
                        child: ListTile(
                          title: Text(
                            HomePageState.arabicvalue == false
                                ...
                                : 'في طبق منفصل ، اخلطي كل مكونات الصلصة معًا',
                            style: TextStyle(
                                fontSize: 20,
                                fontWeight: FontWeight.bold,
                                color: Colors.white),
                        ...
                        child: ListTile(
                          title: Text(
                            HomePageState.arabicvalue == false
                                ...
                                : 'سخني مقلاة غير لاصقة بالزيت. اطهي كل قطعة دجاج حتى يصبح لونها بنياً ذهبياً. أخرج الدجاج من المقلاة. اترك حوالي 1 ملعقة كبيرة زيت في المقلاة للطبخ',
                            style: TextStyle(
                                fontSize: 20,
                                fontWeight: FontWeight.bold,
                                color: Colors.white),
                        ...
                        child: ListTile(
                          title: Text(
                            HomePageState.arabicvalue == false
                                ...
                                : 'نضيف الثوم والزنجبيل ورقائق الفلفل. سوتي لمدة 30 ثانية',
                            style: TextStyle(
                                fontSize: 20,
                                fontWeight: FontWeight.bold,
                                color: Colors.white),
                        ...
                        child: ListTile(
                          title: Text(
                            HomePageState.arabicvalue == false
                                ...
                                : 'أضيفي الصلصة إلى المقلاة واتركيها على نار هادئة ثم أضيفي الدجاج وقلبيها حتى تتغطى. تخدم على الفور!',
                            style: TextStyle(
                                fontSize: 20,
                                fontWeight: FontWeight.bold,
                                color: Colors.white),
