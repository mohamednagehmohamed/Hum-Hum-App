...
void main() => runApp(Yabrak());

class Yabrak extends StatefulWidget {
  @override
  YabrakState createState() => YabrakState();
}

class YabrakState extends State<Yabrak> {
    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          toolbarHeight: 70,
          title: Text(
            HomePageState.arabicvalue == false ? 'Yabrak' : 'يبراك',
            style: TextStyle(
                          ...
                          child: ListTile(
                            title: Text(
                              HomePageState.arabicvalue == false
                                  ...
                                  : 'في حالة استخدام ورق عنب طازج ، أزل السيقان ، ثم اسلقها في الماء المغلي حتى يتغير لونها (حوالي 30 ثانية). يُصفّى جيدًا ويُفصل ويُوضع الأوراق على مناشف الشاي حتى تجف',
                              style: TextStyle(
                                  fontSize: 20,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white),
                          ...
                          child: ListTile(
                            title: Text(
                              HomePageState.arabicvalue == false
                                  ...
                                  : 'نضيف اللحم والأرز ونصف عصير الليمون والقرفة والبهارات والملح والفلفل في وعاء كبير ويخلط جيدا',
                              style: TextStyle(
                                  fontSize: 20,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white),
                          ...
                          child: ListTile(
                            title: Text(
                              HomePageState.arabicvalue == false
                                  ...
                                  : 'ضع طبقة من الأوراق الصغيرة أو المكسورة في قاع إناء كبير بغطاء (قطره حوالي 10 بوصات). يجب أن يكون القدر أكبر من اللوح الذي ستضعه بداخله لاحقًا',
                              style: TextStyle(
                                  fontSize: 20,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white),
                          ...
                          child: ListTile(
                            title: Text(
                              HomePageState.arabicvalue == false
                                  ...
                                  : 'ضعي ورقة على سطح مستوٍ ، بحيث يكون جانب الوريد لأعلى ، ثم ضعي حوالي 1 ملعقة كبيرة من خليط الحشو بالقرب من منتصف قاع الورقة. دس في القاع والجوانب ثم لف بقوة مثل السيجار',
                              style: TextStyle(
                                  fontSize: 20,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white),
                          ...
                          child: ListTile(
                            title: Text(
                              HomePageState.arabicvalue == false
                                  ...
                                  : 'ضع الورقة الملفوفة ، بحيث يكون جانب التماس لأسفل بدقة في القدر. كرر ، ضع الأوراق الملفوفة معًا بشكل وثيق',
                              style: TextStyle(
                                  fontSize: 20,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white),
                          ...
                          child: ListTile(
                            title: Text(
                              HomePageState.arabicvalue == false
                                  ...
                                  : 'غطي الطبقة العليا من الأوراق الملفوفة ببضعة أوراق إضافية',
                              style: TextStyle(
                                  fontSize: 20,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white),
                          ...
                          child: ListTile(
                            title: Text(
                              HomePageState.arabicvalue == false
                                  ...
                                  : 'يُسكب عصير الليمون المتبقي فوق الأوراق في القدر',
                              style: TextStyle(
                                  fontSize: 20,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white),
                          ...
                          child: ListTile(
                            title: Text(
                              HomePageState.arabicvalue == false
                                  ...
                                  : 'أضف كمية كافية من الماء للوصول إلى الطبق.',
                              style: TextStyle(
                                  fontSize: 20,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white),
                          ...
                          child: ListTile(
                            title: Text(
                              HomePageState.arabicvalue == false
                                  ...
                                  : 'خففي الحرارة واتركيها على نار هادئة لمدة 35 دقيقة.',
                              style: TextStyle(
                                  fontSize: 20,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white),
                          ...
                          child: ListTile(
                            title: Text(
                              HomePageState.arabicvalue == false
                                  ...
                                  : 'أطفئ النار واتركها لتبرد لمدة 20 إلى 30 دقيقة',
                              style: TextStyle(
                                  fontSize: 20,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white),
