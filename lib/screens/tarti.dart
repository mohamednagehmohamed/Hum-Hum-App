...
//void main() => runApp(Tarti());

class Tarti extends StatefulWidget {
  @override
  TartiState createState() => TartiState();
}

class TartiState extends State<Tarti> {
  @override
    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          toolbarHeight: 70,
          title: Text(
            HomePageState.arabicvalue == false ? 'Tarte tatin' : 'تارت تأتين',
            style: TextStyle(
                        ...
                        child: ListTile(
                          title: Text(
                            HomePageState.arabicvalue == false
                                ...
                                : '4 كمثرى صغيرة من الزبدة Bosc ، مقشرة ، نصفين ، محفور',
                            style: TextStyle(
                                fontSize: 18,
                                fontWeight: FontWeight.bold,
                                color: Colors.white),
                        ...
                        child: ListTile(
                          title: Text(
                            HomePageState.arabicvalue == false
                                ...
                                : '2 ورقتان (25 سم) من عجينة البف المعجنات الجاهزة المجمدة ، مذوبة للتو',
                            style: TextStyle(
                                fontSize: 18,
                                fontWeight: FontWeight.bold,
                                color: Colors.white),
                        ...
                        child: ListTile(
                          title: Text(
                            HomePageState.arabicvalue == false
                                ...
                                : 'يسخن الفرن إلى 200 درجة مئوية. ضعي الكمثرى في وعاء ورشي عليها عصير الليمون. أضف ملعقتين كبيرتين من السكر. إرم للجمع',
                            style: TextStyle(
                                fontSize: 20,
                                fontWeight: FontWeight.bold,
                                color: Colors.white),
                        ...
                        child: ListTile(
                          title: Text(
                            HomePageState.arabicvalue == false
                                ...
                                : 'ضعي السكر المتبقي في مقلاة 20 سم (قياس القاعدة) على نار خفيفة. يُطهى مع التحريك لمدة 5 دقائق أو حتى يذوب السكر ويبدأ في الكراميل. رتبي الكمثرى ، مع قطع الجانب لأعلى ، حول المقلاة. أضيفي الزبدة واليانسون وعود القرفة. يُطهى ، مغطى بشكل غير محكم ، لمدة 10 دقائق أو حتى ينضج الكمثرى',
                            style: TextStyle(
                                fontSize: 20,
                                fontWeight: FontWeight.bold,
                                color: Colors.white),
                        ...
                        child: ListTile(
                          title: Text(
                            HomePageState.arabicvalue == false
                                ...
                                : 'ضع ورقة عجين واحدة على سطح عمل نظيف. ضعي فوقها ورقة المعجنات المتبقية. استخدم سكينًا حادًا صغيرًا لتقليم العجينة إلى قرص دائري 25 سم. ضع المعجنات فوق الكمثرى في المقلاة مع دس أي فائض من المعجنات. اخبزيها لمدة 30 دقيقة أو حتى تصبح المعجنات ذهبية اللون',
                            style: TextStyle(
                                fontSize: 20,
                                fontWeight: FontWeight.bold,
                                color: Colors.white),
                        ...
                        child: ListTile(
                          title: Text(
                            HomePageState.arabicvalue == false
                                ...
                                : 'يترك جانبا لمدة 10 دقائق ليبرد قليلا. اقلبها على طبق التقديم. مقطعة إلى أسافين. قدميها مع الكريم الطازج مع رش القرفة المطحونة',
                            style: TextStyle(
                                fontSize: 20,
                                fontWeight: FontWeight.bold,
                                color: Colors.white),
