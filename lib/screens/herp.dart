...
//void main() => runApp(Herp());

class Herp extends StatefulWidget {
  @override
  HerpState createState() => HerpState();
}

class HerpState extends State<Herp> {
  @override
    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          toolbarHeight: 70,
          title: Text(
            HomePageState.arabicvalue == false ? 'Herb Omelette' : 'عشب أومليت',
            style: TextStyle(
                        ...
                        child: ListTile(
                          title: Text(
                            HomePageState.arabicvalue == false
                                ...
                                : 'نصف ملعقة صغيرة من زيت الزيتون البكر الممتاز',
                            style: TextStyle(
                                fontSize: 18,
                                fontWeight: FontWeight.bold,
                                color: Colors.white),
                  ...
                  Padding(
                    ...
                    child: Container(
                        ...
                        child: ListTile(
                          title: Text(
                            HomePageState.arabicvalue == false
                                ? 'Herbs such as chives or basi'
                                : 'الأعشاب مثل الثوم المعمر أو القواعد',
                            style: TextStyle(
                                fontSize: 18,
                                fontWeight: FontWeight.bold,
                                color: Colors.white),
                        ...
                        child: ListTile(
                          title: Text(
                            HomePageState.arabicvalue == false
                                ...
                                : 'اخفقي البيض وتبليهما إذا لزم الأمر',
                            style: TextStyle(
                                fontSize: 20,
                                fontWeight: FontWeight.bold,
                                color: Colors.white),
                        ...
                        child: ListTile(
                          title: Text(
                            HomePageState.arabicvalue == false
                                ...
                                : 'بمجرد أن تصبح الزبدة ساخنة ورغوة ، أضيفي البيض المخفوق',
                            style: TextStyle(
                                fontSize: 20,
                                fontWeight: FontWeight.bold,
                                color: Colors.white),
                        ...
                        child: ListTile(
                          title: Text(
                            HomePageState.arabicvalue == false
                                ...
                                : 'عندما تبدأ العجة في النضج ، انقلها باستخدام ملعقة حتى تنضج أي بيضة نيئة متبقية',
                            style: TextStyle(
                                fontSize: 20,
                                fontWeight: FontWeight.bold,
                                color: Colors.white),
                        ...
                        child: ListTile(
                          title: Text(
                            HomePageState.arabicvalue == false
                                ...
                                : 'بمجرد طهي العجة ، أضف الأعشاب التي اخترتها وقدمها',
                            style: TextStyle(
                                fontSize: 20,
                                fontWeight: FontWeight.bold,
                                color: Colors.white),
