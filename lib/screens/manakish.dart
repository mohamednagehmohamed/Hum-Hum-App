...
//void main() => runApp(Manakish());

class Manakish extends StatefulWidget {
  @override
  ManakishState createState() => ManakishState();
}

class ManakishState extends State<Manakish> {
    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          toolbarHeight: 70,
          title: Text(
            HomePageState.arabicvalue == false ? 'Manakish' : 'مناقيش',
            style: TextStyle(
                          ...
                          child: ListTile(
                            title: Text(
                              HomePageState.arabicvalue == false
                                  ...
                                  : '3 1/4 أكواب من الدقيق العادي أو الخبز',
                              style: TextStyle(
                                  fontSize: 18,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white),
                          ...
                          child: ListTile(
                            title: Text(
                              HomePageState.arabicvalue == false
                                  ...
                                  : '1 ملعقة كبيرة خميرة نشطة مجففة',
                              style: TextStyle(
                                  fontSize: 18,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white),
                          ...
                          child: ListTile(
                            title: Text(
                              HomePageState.arabicvalue == false
                                  ...
                                  : '4 ملاعق كبيرة زيت زيتون عادي أو زيت نباتي',
                              style: TextStyle(
                                  fontSize: 18,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white),
                          ...
                          child: ListTile(
                            title: Text(
                              HomePageState.arabicvalue == false
                                  ...
                                  : 'في وعاء ، اختبر إذا كان الماء فاترًا بإصبعك ، إذا كان ساخنًا جدًا سيقتل الخميرة. اضبطه بالماء البارد إذا لزم الأمر',
                              style: TextStyle(
                                  fontSize: 20,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white),
                          ...
                          child: ListTile(
                            title: Text(
                              HomePageState.arabicvalue == false
                                  ...
                                  : 'يضاف السكر إلى الماء مع الخميرة ويقلب جيداً حتى يذوب.اتركه لمدة 15 دقيقة للسماح للخميرة بالتخمر والفقاعات',
                              style: TextStyle(
                                  fontSize: 20,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white),
                          ...
                          child: ListTile(
                            title: Text(
                              HomePageState.arabicvalue == false
                                  ...
                                  : 'في وعاء كبير ، أضيفي الملح والدقيق والزيت وسائل الخميرة واخلطيهم معًا حتى تحصل على كرة. ثم اقلبها إلى سطح مرشوش بالدقيق واعجنها لمدة 5-10 دقائق حتى تعود العجينة إلى الوراء عند كزها',
                              style: TextStyle(
                                  fontSize: 20,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white),
                          ...
                          child: ListTile(
                            title: Text(
                              HomePageState.arabicvalue == false
                                  ...
                                  : 'ضعي كرة العجين في وعاء خلط كبير وغطيه بغشاء بلاستيكي أو قطعة قماش مبللة ، اتركيها لترتفع لمدة ساعتين على الأقل أو حتى يتضاعف حجمها. إذا كانت الغرفة باردة ، ضعها في فرن دافئ ولكن مغلق على أقل درجة',
                              style: TextStyle(
                                  fontSize: 20,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white),
                          ...
                          child: ListTile(
                            title: Text(
                              HomePageState.arabicvalue == false
                                  ...
                                  : 'عندما ينتفخ العجين ، يدق العجين بالأيدي المطحونة ويشكل كرة. تقسم إلى 8 أقسام أو حسب الحجم المطلوب. اتركيه لينقع لمدة ساعة أخرى وغطيه بقطعة قماش موسلين',
                              style: TextStyle(
                                  fontSize: 20,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white),
                    ...
                    Padding(
                      ...
                      child: Container(
                          ...
                          child: ListTile(
                            title: Text(
                              HomePageState.arabicvalue == false
                                  ? 'As the dough proves for the second time prepare your mixtures of either zaatar, cheese or mince meat'
                                  : 'عندما تثبت العجينة للمرة الثانية ، حضري خلطاتك إما من الزعتر أو الجبن أو اللحم المفروم',
                              style: TextStyle(
                                  fontSize: 20,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white),
                          ...
                          child: ListTile(
                            title: Text(
                              HomePageState.arabicvalue == false
                                  ...
                                  : 'لتحضير الزعتر ، قلبي ملعقتين كبيرتين من خليط الزعتر مع نصف كوب من زيت الزيتون العادي',
                              style: TextStyle(
                                  fontSize: 20,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white),
                          ...
                          child: ListTile(
                            title: Text(
                              HomePageState.arabicvalue == false
                                  ...
                                  : 'قم بتشغيل الفرن على أعلى إعداد (عادة 230 درجة مئوية / 450 فهرنهايت)',
                              style: TextStyle(
                                  fontSize: 20,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white),
                          ...
                          child: ListTile(
                            title: Text(
                              HomePageState.arabicvalue == false
                                  ...
                                  : 'افردي كرة صغيرة من العجين على سطح مرشوش بالدقيق لتكون رفيعة جدًا (حوالي 5-10 مم)',
                              style: TextStyle(
                                  fontSize: 20,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white),
                          ...
                          child: ListTile(
                            title: Text(
                              HomePageState.arabicvalue == false
                                  ...
                                  : 'انقلي المكونات إلى صينية غير لاصقة ، ثم ضعيها في خليط الزعتر واتركي هامشًا صغيرًا حول الحواف وقومي بتقطيع السطح بأصابعك برفق.',
                              style: TextStyle(
                                  fontSize: 20,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white),
                          ...
                          child: ListTile(
                            title: Text(
                              HomePageState.arabicvalue == false
                                  ...
                                  : 'اخبز لمدة 10 دقائق ، مع التقليب إلى منتصف الطريق إذا لزم الأمر للحصول على خبز متساوٍ',
                              style: TextStyle(
                                  fontSize: 20,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white),
                          ...
                          child: ListTile(
                            title: Text(
                              HomePageState.arabicvalue == false
                                  ...
                                  : 'يقدم مع طبق مخلل ، طماطم ، نعناع و فجل',
                              style: TextStyle(
                                  fontSize: 20,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white),
