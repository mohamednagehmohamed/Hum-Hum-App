...
//void main() => runApp(Maklopa());

class Maklopa extends StatefulWidget {
  @override
  MaklopaState createState() => MaklopaState();
}

class MaklopaState extends State<Maklopa> {
  @override
    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          toolbarHeight: 70,
          title: Text(
            HomePageState.arabicvalue == false ? 'Al-Maglouba' : 'المقلوبة',
            style: TextStyle(
                        ...
                        child: ListTile(
                          title: Text(
                            HomePageState.arabicvalue == false
                                ? '1 medium eggplant (1 pound) Salt'
                                : '1 باذنجان متوسط ​​(1 باوند) ملح',
                            style: TextStyle(
                                fontSize: 18,
                                fontWeight: FontWeight.bold,
                                color: Colors.white),
                        ...
                        child: ListTile(
                          title: Text(
                            HomePageState.arabicvalue == false
                                ...
                                : '2 كوب أرز طويل الحبة ، مغسول جيداً ومصفى',
                            style: TextStyle(
                                fontSize: 18,
                                fontWeight: FontWeight.bold,
                                color: Colors.white),
                        ...
                        child: ListTile(
                          title: Text(
                            HomePageState.arabicvalue == false
                                ...
                                : '1 بصلة صغيرة مقطّعة إلى أسافين كبيرة',
                            style: TextStyle(
                                fontSize: 18,
                                fontWeight: FontWeight.bold,
                                color: Colors.white),
                        ...
                        child: ListTile(
                          title: Text(
                            HomePageState.arabicvalue == false
                                ...
                                : '3 إلى 5 جزر متوسط ​​الحجم 2 أو 3 إنش',
                            style: TextStyle(
                                fontSize: 18,
                                fontWeight: FontWeight.bold,
                                color: Colors.white),
                        ...
                        child: ListTile(
                          title: Text(
                            HomePageState.arabicvalue == false
                                ...
                                : '1 حبة بطاطس متوسطة ، شرائح 1/2 بوصة',
                            style: TextStyle(
                                fontSize: 18,
                                fontWeight: FontWeight.bold,
                                color: Colors.white),
                        ...
                        child: ListTile(
                          title: Text(
                            HomePageState.arabicvalue == false
                                ...
                                : 'كوب شعيرية مكسورة (انظر الملاحظة)',
                            style: TextStyle(
                                fontSize: 18,
                                fontWeight: FontWeight.bold,
                                color: Colors.white),
                        ...
                        child: ListTile(
                          title: Text(
                            HomePageState.arabicvalue == false
                                ...
                                : 'ملعقة صغيرة بهار جويا سازون (اختياري)',
                            style: TextStyle(
                                fontSize: 18,
                                fontWeight: FontWeight.bold,
                                color: Colors.white),
                        ...
                        child: ListTile(
                          title: Text(
                            HomePageState.arabicvalue == false
                                ...
                                : 'طماطم مقطعة وخيار وبقدونس وعصير ليمون وزيت زيتون للتقديم (اختياري)',
                            style: TextStyle(
                                fontSize: 18,
                                fontWeight: FontWeight.bold,
                                color: Colors.white),
                        ...
                        child: ListTile(
                          title: Text(
                            HomePageState.arabicvalue == false
                                ...
                                : 'قطع الباذنجان إلى نصف أقمار بسمك 1/2 بوصة. يتبل جيدا بالملح ، ويترك لمدة 30 دقيقة. ضع الدجاج في قدر كبير (حجمه 10 بوصات ، 5 كوارت مثالي) ، وتبليه جيدًا بالملح وملعقة صغيرة من الفلفل الأسود والكمون المطحون والقرنفل وحبوب الهال وأوراق الغار (يفضل القيام بذلك في اليوم السابق. ). صب 3 أكواب من الماء المغلي فوق الأرز. ينقع لمدة 10 دقائق ، ثم يصفى جيدًا',
                            style: TextStyle(
                                fontSize: 20,
                                fontWeight: FontWeight.bold,
                                color: Colors.white),
                        ...
                        child: ListTile(
                          title: Text(
                            HomePageState.arabicvalue == false
                                ...
                                : 'أضيفي إلى الدجاج أسافين البصل وملعقة كبيرة ملح و 4 1/2 أكواب من الماء. يُغلى المزيج ، ويُغطى ، على نار عالية ، ثم يُغلى المزيج على نار خفيفة ، ويُطهى لمدة 20 دقيقة. صفّي الدجاج مع الحفاظ على المرق وتخلصي من البصل والبهارات',
                            style: TextStyle(
                                fontSize: 20,
                                fontWeight: FontWeight.bold,
                                color: Colors.white),
                        ...
                        child: ListTile(
                          title: Text(
                            HomePageState.arabicvalue == false
                                ...
                                : 'سخني 1/2 إنش من الزيت في مقلاة كبيرة على نار متوسطة عالية حتى يضيء ساخناً ، ثم اقلي الجزر على دفعات إذا لزم الأمر ، مع التقليب من حين لآخر حتى يتحول إلى اللون البني ، حوالي 4 دقائق. صفيها على مناديل ورقية ثم تبليها قليلًا بالملح. كرر ذلك مع البطاطس ، حوالي 3 دقائق لكل جانب. كرر ذلك مع القرنبيط ، حوالي 7 دقائق لكل دفعة. أخيرًا ، اضغط على الباذنجان بمنشفة ورقية حتى يجف ، ثم اقلي الباذنجان في طبقة واحدة حتى يتحول إلى اللون البني ، لمدة 4 دقائق لكل دفعة. صفي مناديل ورقية ، لكن لا تتبل. (إذا كان الباذنجان دهنيًا جدًا ، اضغط عليه بمناشف ورقية',
                            style: TextStyle(
                                fontSize: 20,
                                fontWeight: FontWeight.bold,
                                color: Colors.white),
                        ...
                        child: ListTile(
                          title: Text(
                            HomePageState.arabicvalue == false
                                ...
                                : 'اسكبي الزيت مع الاحتفاظ ب 2 12 ملعقة كبيرة في المقلاة. سخنيها على نار متوسطة - عالية وأضيفي الشعيرية مع التحريك لمدة دقيقتين حتى يتحول لونها إلى البني. يُضاف الأرز المصفى ويُطهى مع التحريك حتى يجف لمدة 4 دقائق. نضيف 1 ملعقة كبيرة ملح و 1/2 ملعقة صغيرة فلفل أسود والكركم والقرفة والبهارات والقرنفل المطحون والصلصة والثوم ونقلب مع التحريك حتى تفوح رائحته.',
                            style: TextStyle(
                                fontSize: 20,
                                fontWeight: FontWeight.bold,
                                color: Colors.white),
                        ...
                        child: ListTile(
                          title: Text(
                            HomePageState.arabicvalue == false
                                ...
                                : 'ضعي الدجاج مرة أخرى في القدر مع وضع الجلد لأسفل. نضع الخضار في الأعلى ثم الأرز. صب 4 أكواب من مرق الدجاج. اضغط على الأرز. أضف المزيد من المرق أو الماء إذا لزم الأمر حتى يصل السائل بالكاد إلى مستوى الأرز. غطي الوعاء واتركيه حتى يغلي على نار عالية ، ثم اخفضه إلى درجة حرارة متوسطة منخفضة. بعد 10 دقائق ، قلّبي الأرز فقط بحذر لمزج الأرز الصلب فوقه بالتساوي. كرر بعد 10 دقائق أخرى. بعد 30 دقيقة ، يجب أن ينضج الأرز ، لكن ليس طريًا ، ويجب امتصاص السائل',
                            style: TextStyle(
                                fontSize: 20,
                                fontWeight: FontWeight.bold,
                                color: Colors.white),
                        ...
                        child: ListTile(
                          title: Text(
                            HomePageState.arabicvalue == false
                                ...
                                : 'ضع طبق تقديم كبير جدًا فوق القدر ، ثم احمي يديك (وربما مع شريك) ، اقلب القدر على الطبق بحركة سلسة واحدة. إذا كان هناك سائل يتسرب للخارج ، فقم بملعقته أو انقعه بالمناشف الورقية. اترك الوعاء يستريح لمدة 5 دقائق على الأقل',
                            style: TextStyle(
                                fontSize: 20,
                                fontWeight: FontWeight.bold,
                                color: Colors.white),
                        ...
                        child: ListTile(
                          title: Text(
                            HomePageState.arabicvalue == false
                                ...
                                : 'في هذه الأثناء ، سخني ملعقتين كبيرتين من الزيت في مقلاة صغيرة على نار متوسطة عالية حتى تتلألأ. تقلى الصنوبر مع التحريك باستمرار حتى تحمر لمدة 1 دقيقة. صفي مناديل ورقية',
                            style: TextStyle(
                                fontSize: 20,
                                fontWeight: FontWeight.bold,
                                color: Colors.white),
                        ...
                        child: ListTile(
                          title: Text(
                            HomePageState.arabicvalue == false
                                ...
                                : 'ارفع القدر لتكشف المقلوبة ، وانثر حبات الصنوبر في كل مكان. يقدم مع الزبادي والطماطم المفرومة والخيار والبقدونس على الجانب المتبلة بالليمون والملح وزيت الزيتون',
                            style: TextStyle(
                                fontSize: 20,
                                fontWeight: FontWeight.bold,
                                color: Colors.white),
