...
//void main() => runApp(Chila());

class Chila extends StatefulWidget {
  @override
  ChilaState createState() => ChilaState();
}

class ChilaState extends State<Chila> {
  @override
    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          toolbarHeight: 70,
          title: Text(
            HomePageState.arabicvalue == false ? 'Chilaquiles' : 'تشيلاكويليس',
            style: TextStyle(
                  ...
                  Padding(
                    ...
                    child: Container(
                        ...
                        child: ListTile(
                          title: Text(
                            HomePageState.arabicvalue == false
                                ? '12 corn tortillas, cut into 8 wedges each Kosher salt'
                                : '12 تورتيلا ذرة ، مقطعة إلى 8 أسافين لكل منهاالملح كوشير',
                            style: TextStyle(
                                fontSize: 18,
                                fontWeight: FontWeight.bold,
                                color: Colors.white),
                        ...
                        child: ListTile(
                          title: Text(
                            HomePageState.arabicvalue == false
                                ...
                                : '4 طماطم روما أو 2 طماطم كبيرة (حوالي 1 1/2 رطل) ، مفرومة',
                            style: TextStyle(
                                fontSize: 18,
                                fontWeight: FontWeight.bold,
                                color: Colors.white),
                  ...
                  Padding(
                    ...
                    child: Container(
                        ...
                        child: ListTile(
                          title: Text(
                            HomePageState.arabicvalue == false
                                ? '1 medium jalapeño, slice (remove the seeds for a less spicy dish'
                                : '1 حبة فلفل متوسط ​​الحجم مقطعة شرائح (ترفع البذور للحصول على طبق أقل حارة',
                            style: TextStyle(
                                fontSize: 18,
                                fontWeight: FontWeight.bold,
                                color: Colors.white),
                        ...
                        child: ListTile(
                          title: Text(
                            HomePageState.arabicvalue == false
                                ...
                                : '1 1/4 كوب مرق دجاج أو خضروات قليل الصوديوم ، مقسم',
                            style: TextStyle(
                                fontSize: 18,
                                fontWeight: FontWeight.bold,
                                color: Colors.white),
                        ...
                        child: ListTile(
                          title: Text(
                            HomePageState.arabicvalue == false
                                ...
                                : 'تقلى التورتيلا. سخني 1/4 كوب زيت في مقلاة كبيرة على نار متوسطة عالية حتى يتلألأ. يُضاف حوالي ربع شرائح التورتيلا ويُطهى مع التقليب مرة واحدة حتى يصبح لونه بني فاتح ومقرمش',
                            style: TextStyle(
                                fontSize: 20,
                                fontWeight: FontWeight.bold,
                                color: Colors.white),
                        ...
                        child: ListTile(
                          title: Text(
                            HomePageState.arabicvalue == false
                                ...
                                : 'صفي رقائق التورتيلا. صفي رقائق التورتيلا المقلية الطازجة على صينية خبز مبطنة بمنشفة ورقية. يرش القليل من الملح. كرر هذه العملية حتى تقلى جميع التورتيلا ، مع إضافة المزيد من الزيت إذا لزم الأمر',
                            style: TextStyle(
                                fontSize: 20,
                                fontWeight: FontWeight.bold,
                                color: Colors.white),
                        ...
                        child: ListTile(
                          title: Text(
                            HomePageState.arabicvalue == false
                                ...
                                : 'اصنع السالسا روجا. ضع الطماطم والبصل والهلابينو والثوم في الخلاط أو محضر الطعام المزود بالشفرة المرفقة. صب 1 كوب من المرق. حتى مزيج سلس',
                            style: TextStyle(
                                fontSize: 20,
                                fontWeight: FontWeight.bold,
                                color: Colors.white),
                        ...
                        child: ListTile(
                          title: Text(
                            HomePageState.arabicvalue == false
                                ...
                                : 'اطبخ الصلصة. سخني ملعقتين صغيرتين من الزيت في مقلاة كبيرة على نار متوسطة عالية حتى يتلألأ. تُضاف الصلصة وتُطهى مع التحريك من حين لآخر ، حتى تصبح سميكة قليلاً ، من 5 إلى 10 دقائق (يختلف قوام الصلصة حسب حجم الطماطم وعصيرها). أضف مرقًا إضافيًا لتخفيف الصلصة إذا لزم الأمر. تذوق وتتبل بالملح حسب الحاجة',
                            style: TextStyle(
                                fontSize: 20,
                                fontWeight: FontWeight.bold,
                                color: Colors.white),
                        ...
                        child: ListTile(
                          title: Text(
                            HomePageState.arabicvalue == false
                                ...
                                : 'غطي الرقائق بالصلصة. أضيفي رقائق التورتيلا وقلبي بعناية لتغطي الرقائق. اطبخي حتى تسخين التورتيلا لمدة 3 دقائق تقريبًا. تذوق وتتبل بالملح حسب الحاجة',
                            style: TextStyle(
                                fontSize: 20,
                                fontWeight: FontWeight.bold,
                                color: Colors.white),
                        ...
                        child: ListTile(
                          title: Text(
                            HomePageState.arabicvalue == false
                                ...
                                : 'قدميها دافئة. قدميها دافئة مزينة بالأفوكادو أو جواكامولي ، كريما ، فريسكو كويسو ، و / أو بيض مقلي ، إذا رغبت في ذلك',
                            style: TextStyle(
                                fontSize: 20,
                                fontWeight: FontWeight.bold,
                                color: Colors.white),
