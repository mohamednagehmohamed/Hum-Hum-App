...
//void main() => runApp(Banana());

class Banana extends StatefulWidget {
  @override
  BananaState createState() => BananaState();
}

class BananaState extends State<Banana> {
                          ...
                          child: ListTile(
                            title: Text(
                              HomePageState.arabicvalue == false
                                  ...
                                  : 'قشر وقطع الموز الناضج وأضفه إلى الخلاط.',
                              style: TextStyle(
                                  fontSize: 20,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white),
                          ...
                          child: ListTile(
                            title: Text(
                              HomePageState.arabicvalue == false
                                  ...
                                  : 'يُسكب الحليب في الخلاط ويُسكب في الشوفان',
                              style: TextStyle(
                                  fontSize: 20,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white),
                          ...
                          child: ListTile(
                            title: Text(
                              HomePageState.arabicvalue == false
                                  ...
                                  : ' ضعي المزيج في الخلاط حتى يبدو المزيج ناعمًا ورقيقًا ، ثم قدميه',
                              style: TextStyle(
                                  fontSize: 20,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white),
